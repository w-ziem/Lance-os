/**
 * Projects Page for FreelanceOS
 * 
 * Main page for project management with Kanban or list view.
 */
          ...
          <div className="flex justify-between h-16">
            <div className="flex items-center">
              ...
              <div className="hidden sm:ml-8 sm:flex sm:space-x-4">
                ...
                <Link to="/projects" className="text-gray-900 hover:text-blue-600 px-3 py-2 text-sm font-medium">Projects</Link>
      ...
      <main className="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center mb-6">
          ...
          <div className="flex gap-4">
            <div className="flex rounded-lg overflow-hidden border">
              <button className="px-4 py-2 bg-blue-600 text-white">List</button>
              <button className="px-4 py-2 bg-white text-gray-700">Kanban</button>
            </div>
        ...
        <div className="bg-white shadow rounded-lg p-6">
          ...
          <p className="text-sm text-gray-400 mt-2">
            This page will display project list, kanban board, and CRUD operations.
          </p>
        </div>
      </main>
    </div>
